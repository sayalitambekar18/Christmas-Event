...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="85" class="body">
    <audio src="./resoureces/ton.mp3" autoplay="autoplay" loop="loop">sound</audio>
    <div class="snowflake">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="report.jsp"><b>Report</b></a>
                        </li>
                        <li class="nav-item">
...
<div style="padding:50px">
	<h2>Welcome!!</h2><br>
    <h3 class="animate__animated animate__jackInTheBox animate__delay-1s"> <%= request.getParameter("Umail") %></h3>
    <br>
